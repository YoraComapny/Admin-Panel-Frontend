import { getIosSettings, iosCreateUpdateSettings } from "../../Api";
...
const IosSettingGeneral = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      setLoading(true);
      try {
        const response = await getIosSettings();
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await iosCreateUpdateSettings(formData);
...
export default IosSettingGeneral;
