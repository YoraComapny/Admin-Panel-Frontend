...
import Adds from "../ManageAdd/Adds";
import CreateAdds from "../ManageAdd/CreateAdd";
...
const TypesAdd = () => {
  ...
  const [refreshData, setRefreshData] = useState(0); // Add refresh state
  ...
  const handleSubmit = (data) => {
    ...
    // Trigger refresh after create or update
      ...
      <div className="flex flex-col min-h-screen bg-[#fafafa] p-3 md:p-6  ">
        ...
        {loading ? (
          ...
          <Adds
            ...
            perPage={perPage}
            refreshTrigger={refreshData} // Pass refresh trigger
          />
        )}
      </div>
    </Portal>
